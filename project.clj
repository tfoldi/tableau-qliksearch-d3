(defproject tableau-qliksearch-d3 "0.1.0-SNAPSHOT"
  ...
  :uberjar-name "tableau-qliksearch-d3.jar"

  ;; Use `lein run` if you just want to start a HTTP server, without figwheel
  :main tableau-qliksearch-d3.server
  ...
  :cljsbuild {:builds
              [{:id "app"
                ...
                ;; :figwheel {:on-jsload "tableau-qliksearch-d3.core/on-figwheel-reload"}

                :compiler {:main tableau-qliksearch-d3.core
                           :asset-path "js/compiled/out"
                           :output-to "resources/public/js/compiled/tableau_qliksearch_d3.js"
               ...
               {:id "test"
                ...
                :compiler {:output-to "resources/public/js/compiled/testable.js"
                           :main tableau-qliksearch-d3.test-runner
                           :optimizations :none}}
